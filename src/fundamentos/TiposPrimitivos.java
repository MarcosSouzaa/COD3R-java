...
public class TiposPrimitivos {
	...
	public static void main(String[] args) {		
	    ...
	    /* O Tipo long, quando uso um literal, posso usar _ underline
		  para separar as casas de milhares (mil, milhão etc)
	      se não ultrapassar o range, o java faz a conversão implicita
	      para inteiro. 
	      Se ultrapassar o range, tenho que colocar a letra L.	      
		*/
		...
		/* Qualquer tipo com ponto flutuante é do tipo DOUBLE, que é o dobro de float
		  o que significa que não vou conseguir colocar double dentro de float.
		  float salario = 11_445.44; Nesse caso vai dar erro.
		  Mas se eu quiser que esse valor seja um float, preciso colocar a letra F.
		*/
